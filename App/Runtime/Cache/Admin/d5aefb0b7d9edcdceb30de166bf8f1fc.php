...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font">
            ...
            <span class="crumb-step">&gt;</span><span class="crumb-name">课程管理</span></div>
    </div>
    <div class="result-wrap">
        <form action="<?php echo U('Train/course_add');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
            <div class="config-items">
                <div class="config-title">
                    <h1><i class="icon-font">&#xe00a;</i>课程添加</h1>
                </div>
                <div class="result-content">
                    <table width="100%" class="insert-tab">
                        ...
                        <tr>
                            ...
                            <td><input id="course_name" name="course_name" value="<?php echo ($info["course_name"]); ?>" type="text"  class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>课程图片：</th>
                            <td><input id="course_img" name="course_img" value="<?php echo ($info["course_img"]); ?>" type="file"  class="common-text">
                                <img src="<?php echo ($info["course_img"]); ?>" style="width: 100px;height: 100px" alt="">
                            </td>
                            <input type="hidden" name="course_img1" value="<?php echo ($info["course_img"]); ?>">
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>介绍：</th>
                            <td>
                                <textarea name="introduce" style=" height: initial;" id="introduce" class="common-text btn50" cols="30" rows="3"><?php echo ($info["introduce"]); ?></textarea>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo U('Train/teacher');?>"><input type="button" value="返回"  class="btn btn6"></a>
                            </td>
                        </tr>
                        </tbody></table>
                </div>
