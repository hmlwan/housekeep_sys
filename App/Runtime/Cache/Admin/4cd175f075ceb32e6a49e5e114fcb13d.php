...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list">
            ...
            <span class="crumb-name">特色服务</span>
        </div>
    </div>
    ...
    <div class="result-wrap">
        ...
        <div class="result-title">
            <div class="result-list">
                <a href="<?php echo U('Company/special_add');?>#4#0"><i class="icon-font"></i>新增特色服务</a>
            </div>
            <!--<form action="<?php echo U('Company/info');?>" method="get">-->
                ...
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a href="<?php echo ($vo['img']); ?>" target="_blank">
                                <img src="<?php echo ($vo['img']); ?>" style="height: 100px;width: 100px" alt="">
                            </a>
                        </td>
                        ...
                        <td>
                            <a class="link-update" href="<?php echo U('Company/special_add#4#0',array('id'=>$vo['id']));?>#4#0">修改|</a>
...
<script>
    function cexiao(id){
        layer.confirm('确定删除吗？', {
            ...
            $.post("<?php echo U('Company/del');?>",{id:id,model:'special_service'},function(data){
                if(data['status'] == 1){
