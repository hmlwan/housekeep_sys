    ...
    <div class="result-wrap">
        ...
        <div class="result-title">
            <div class="result-list">
                <a href="<?php echo U('Train/course_add');?>#1#0"><i class="icon-font"></i>新增师资</a>
            </div>
            <form action="<?php echo U('Train/course');?>" method="get">
                <table class="search-tab">
                    <tr>
                        <td width="80">课程名称:</td>
                        <td><input class="common-text" placeholder="课程名称" name="string" type="text" value="<?php echo ($_GET['string']); ?>"></td>
        ...
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <?php if($vo['course_img']): ?><a href="<?php echo ($vo['course_img']); ?>" target="_blank">
                                    <img src="<?php echo ($vo['course_img']); ?>" style="width: 100px;height: 100px" alt="">
                                </a><?php endif; ?>
                        </td>
                        <td style="width: 50%;"><?php echo ($vo['introduce']); ?></td>
                        ...
                        <td>
                            <a class="link-update" href="<?php echo U('Train/course_add#1#0',array('id'=>$vo['id']));?>#13#0">修改|</a>
...
<script>
    function cexiao(id){
        layer.confirm('确定删除吗？', {
            ...
            $.post("<?php echo U('Train/del');?>",{id:id,model:'train_course'},function(data){
                if(data['status'] == 1){
